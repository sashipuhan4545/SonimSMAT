...
public class XP3_QuickSanity_Util extends BaseUtil{

	public String b_No="";
	public String p_b_No="";
	public String p_Id="";
	public String r_Id="";
	public String r_b_No="";
	public String pryNum=AllQA.PRIMARYDEVMDN;
	...
	public static void MT_CALL_Sanity() throws IOException, InterruptedException, ParseException {
	...
	public static void MT_CALL_REJECT_Sanity() throws IOException, InterruptedException, ParseException {
	...
	public void sendSMSWhenInCall(String text) throws InterruptedException, IOException, ParseException
	{
		/*
	...
	public void speakerStatus() throws InterruptedException, IOException
	{
		...
		try {
			aDriver.pressKeyCode(AndroidKeyCode.KEYCODE_DPAD_UP);
			customWait(2000);
			validateInCallFunctionality("Speaker On","Entering state ActiveSpeakerRoute: ICA.sAR->CARSM.pM_USER_SWITCH_SPEAKER");
			aDriver.pressKeyCode(AndroidKeyCode.KEYCODE_DPAD_UP);
			customWait(2000);
			validateInCallFunctionality("Speaker Off","Leaving state ActiveSpeakerRoute: ICA.sAR->CARSM.pM_USER_SWITCH_EARPIECE");
		}catch (Exception e) {
			e.printStackTrace();
			test.log(LogStatus.ERROR, "Element Not Found");
		}
	...
	public void validateInCallFunctionality(String function,String searchstring) throws InterruptedException, IOException
	{
		...
		SoftAssert SA = new SoftAssert();
		try {
			boolean value = searchString(searchstring, "XP3_QuickSanity_07");
			if(value)
			{
				check = true;
	...
	public void checkBasebandVersion() throws InterruptedException {
		...
		try {
			...
			if (version.equalsIgnoreCase(JsonFileReaderAndWriter.primaryDevOperatorReader())){
				...
				SA.assertTrue(check, "Baseband version strings match");
				test.log(LogStatus.PASS, "Baseband versions match");
			}
		}
		catch (Exception e){
			SA.fail();
