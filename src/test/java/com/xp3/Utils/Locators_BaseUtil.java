...
public class Locators_BaseUtil {
	...
	public static AndroidElement camera_Icon;//com.sonim.borqs.launcher:id/icon_text

	@AndroidFindBy(xpath="//android.widget.TextView[@text='Camera']")	
	public static AndroidElement cameraApp;//com.sonim.borqs.launcher:id/icon_text
