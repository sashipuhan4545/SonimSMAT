...
public class Locators_DevSanity {
	...
	@AndroidFindBy(xpath="//android.widget.TextView[@text='Baseband version']/../*[@resource-id='android:id/summary']")
	...
	@AndroidFindBy(xpath="//com.android.internal.widget.AccessibleTextView[@text='Refresh']")
	public static AndroidElement refresh_page;	
	...
	@FindBy(how=How.XPATH, using ="//android.widget.LinearLayout[contains(@resource-id,'com.android.browser:id/tab_switcher')]")
	public static AndroidElement browserTabSwitcher;
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@text='Wi-Fi']")
	public static AndroidElement wifiButton;

	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id='com.android.mms:id/from']")
	public static AndroidElement msgFrom;	

	@FindBy(how=How.XPATH, using =("//android.widget.TextView[contains(@text,'data')]/../..//android.widget.Switch[@text='ON']"))
	public static AndroidElement enabled_Data;

	@FindBy(how=How.XPATH, using =("//android.widget.TextView[contains(@text,'data')]/../..//android.widget.Switch[@text='OFF']"))
	...
	@AndroidFindBy(uiAutomator = "new UiSelector().className(\"android.widget.TextView\").textcontains(\"Warranty Registration\")")
