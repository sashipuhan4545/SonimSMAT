...
public class New_SanityLocators {
	...
	@AndroidFindBy(uiAutomator="new UiSelector().className(\"android.widget.TextView\").resourceId(\"com.google.android.gm:id/account_address\")")
	public static AndroidElement account_address;
	
	@AndroidFindBy(uiAutomator="new UiSelector().className(\"android.widget.Switch\").resourceId(\"android:id/switch_widget\")")
	public static AndroidElement data_switch;
