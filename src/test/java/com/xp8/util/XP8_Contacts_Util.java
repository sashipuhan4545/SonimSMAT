...
public class XP8_Contacts_Util extends BaseUtil {
	...
	public String pryNum = HomeController.PRIMARYDEVMDN;		// Reference Dmevice MDN. 
	public String refNum = HomeController.REFERENCEDEVMDN.replaceAll("[^0-9]", "");	// Reference Device MDN.
