...
import com.xp8.util.XP8_PhoneDialer_Util_old;

import io.appium.java_client.pagefactory.AppiumFieldDecorator;

public class XP8_PhoneDialer_Test_old extends XP8_PhoneDialer_Util_old{
	...
	public void setupSys() throws MalformedURLException, InterruptedException, FileNotFoundException, AWTException{
		...
		Locators_PhoneDialer_old loc=new Locators_PhoneDialer_old(aDriver);
	...
	public void XP8_PhoneDialer_17_Validate_Delete(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException
	{
		...
		//("XP8_PhoneDialer_17");
		launch_an_app("phone");
		navigateToCallDetails(Locators_PhoneDialer_old.editedNumber);
		minWait();
		validateDelete();
	}
	...
	public void XP8_PhoneDialer_25_Validate_Quick_Responses(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException
	{
		...
		//("XP8_PhoneDialer_25");
		launch_an_app("phone");
		navigateToSettingsAndElement(Locators_PhoneDialer_old.quickResponseOpt);
		minWait();
	...
	public void XP8_PhoneDialer_26_Validate_Speed_Dial_Settings(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException
	{
		...
		//("XP8_PhoneDialer_26");
		launch_an_app("phone");
		navigateToSettingsAndElement(Locators_PhoneDialer_old.speedDialSettingsOpt);
		minWait();
