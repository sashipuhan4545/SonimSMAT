...
import com.xp5S.util.XP5S_Sanity_Util_Bell;
...
public class XP5S_Sanity_Test_Bell extends XP5S_Sanity_Util_Bell {
	...
	public void beforeSuite() throws IOException 
	{
		...
		extent = new ExtentReports("src/test/resources/extentreport/XP5S_BELL_Sanity_TestReport.html", true);
	...
	public void XP5S_Sanity_PTT_17_EnableMHS_And_Check_EntitlementError(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException 
	{
		...
		if(XP5deviceModelNumber.contains("ATT")) {
			...
			turn_ON_MobileData();
			//		  turn_ON_USBtethering();//bcz device disconnects
