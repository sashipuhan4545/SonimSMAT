...
public class Locators_ScoutSanity {


	private static AndroidDriver<AndroidElement> aDriver;

	public Locators_ScoutSanity(AndroidDriver<AndroidElement> aDriver) {
		this.aDriver=aDriver;

	}
	
	@AndroidFindBy(xpath="//android.widget.TextView[@text='']")
	public static WebElement template_xpath;
	
	@AndroidFindBy(uiAutomator="new UiScrollable().resourceId(\"com.sonimtech.easycontactsshare:id/btnSelectVcfFile\")")
	public static WebElement vcf_file_contact_transfer;
	
	
	@AndroidFindBy(uiAutomator="new UiScrollable().className(\"android.widget.ListView\")")
	public static WebElement scrollList;
	
	@AndroidFindBy(uiAutomator="new UiScrollable().className(\"android.widget.ScrollView\")")
	...
	public static WebElement device_Information;

	@AndroidFindBy(xpath = "//android.widget.TextView[@text='Remote Support']")
	public static WebElement RemoteSupport;

	@AndroidFindBy(xpath = "//android.widget.TextView[@text='Remote Support' or 'Remote Control']")
	public static WebElement Remote;

	
	@AndroidFindBy(xpath = "//android.view.View[@content-desc='Remote Control']")
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id='com.sonim.scout:id/Device_model_summary']")
	...
	public static WebElement sonimChat_app;
	...
	public static WebElement SWR_CANCEL_Btn;
	...
	@AndroidFindBy(uiAutomator="new UiSelector().packageName(\"com.sonim.safeguard\").resourceId(\"com.sonim.safeguard:id/editText\")")
	public static WebElement SG_Pin;
	...
	public static WebElement cameraPass_Confirmation_dialog;
	 ...
	 public static WebElement batteryDiagnosis;
	    ...
	    public static WebElement noAppUpdate;
