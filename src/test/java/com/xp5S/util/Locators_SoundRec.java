...
private static AndroidDriver<AndroidElement> aDriver;
	...
	@FindBy(how=How.XPATH, using =("//android.support.v7.widget.RecyclerView[@index='1']/android.widget.ImageButton[@index='6']"))
	...
	@FindBy(how=How.XPATH, using ="//android.widget.ImageButton[contains(@resource-id,'com.android.soundrecorder:id/player_controller')]")
	 public static WebElement PlayIcon;
	...
	@FindBy(how=How.XPATH, using ="//com.android.internal.widget.AccessibleTextView[contains(@text,'Select')]")
	public static WebElement SelectOpt;
	
	@FindBy(how=How.XPATH, using ="//com.android.internal.widget.AccessibleTextView[contains(@text,'Deselect all')]")
	...
	@FindBy(how=How.XPATH, using ="//android.widget.TextView[@text='Recording list']")
	...
	@FindBy(how=How.XPATH, using ="//android.widget.TextView[contains(@text,'SoundRecorder')]")
	public static WebElement SoundRecOptn;
