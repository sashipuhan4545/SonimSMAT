...
public class XP5S_Device_QA_Sanity_O_Test extends XP5S_Sanity_Util_Oreo {
	...
	{
		extent = new ExtentReports("src/test/resources/extentreport/XP5S_Device_QA_Sanity_Oreo_TestReport.html", true); 
	...
	public void XP5S_TC_002_Sanity_AboutPhone_Build_and_Baseband_Version(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException, ParseException {
		...
		navigateToOptions(Locators_Sanity.BasebandVersion); 
		navigateToOptions(Locators_Sanity.BuildNumber); 
		validateAboutPhone();
		test.log(LogStatus.PASS, "Test case status is Passed");
	}
	...
	public void XP5S_TC_004_Sanity_Diplaying_OperaterName_HomeScreen(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_005_Sanity_Make_MO_VoiceCall(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_006_Sanity_Send_SMS_Ongoing_VoiceCall(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_007_Sanity_Hold_and_Retreive_Call(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_008_Sanity_In_Call_functionality_Mute_Speaker_ON_OFF(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_009_Sanity_Make_MT_VoiceCall(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_010_Sanity_Reject_MT_Voice_Call(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_012_Sanity_MO_VoiceCall_from_CallHistory(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_013_Sanity_Call_History_details(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_014_Sanity_Send_SMS_NewNumber(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_015_Sanity_Send_SMS_SavedContact(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_016_Sanity_Send_SMS_With_AlphaNumeric_SpecialCharacters(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_017_Sanity_Send_MultiPage_SMS(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_018_Sanity_Receive_SMS(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_019_Sanity_Save_SMS_as_Draft_and_Delete(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_020_Sanity_Send_MMS(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
		...
		capturePic_ADD();
		validate_AnyAdded_Attachment(Locators_Sanity.image_Attachment_oreo);
		customWait(2000);
		enter_ToField();
		customWait(2000);
	...
	public void XP5S_TC_021_Sanity_Delete_MMS(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_022_Sanity_Create_Contact_with_all_Fields_In_PhoneMemory(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_023_Sanity_Create_Contact_Name_ContactNumber_SIM_Memory(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_024_Sanity_Delete_Saved_Contacts(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_025_Sanity_Enable_Disable_MobileData_DeviceSettings(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_026_Sanity_Connection_Secured_Wifi_Enable_Disable_Wifi_DeviceSettings(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_027_Sanity_Enable_Disable_Airplane_Devicesettings(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
		...
		launch_an_app("settings");
		checkFlightmodeStatusAndValidate();
		test.log(LogStatus.PASS, "Test case status is Passed");
	}

	@Test(priority=28,dataProvider="XP5_AOSP_Sanity", dataProviderClass=DataProviders.class)
	public void XP5S_TC_028_Sanity_Enable_Disable_Bluetooth_Devicesettings(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
	...
	public void XP5S_TC_030_Sanity_Enable_Disable_Location_Devicesettings(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
		...
		launch_an_app("settings");
		navigateToSettingsFeature(Locators_Sanity.securityAndLocation,"Security & location");
		clickBtn(Locators_Sanity.Location_feature);
		disableFeature(Locators_Sanity.enabled,Locators_Sanity.disabled);
	...
	public void XP5S_TC_033_Sanity_Enable_Disable_AirplaneMode_QuickSettings(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
		...
		selectQuickSettingPanel();
		navigateToAirplaneModeOptionQuickSettings();
	...
	public void XP5S_TC_047_Sanity_TakePicture_With_Back_Camera(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
		...
		//validateBackCamera("android.hardware.action.NEW_PICTURE","capturepicture","Camera","XP5S_Sanity_047");
		test.log(LogStatus.PASS, "Test case status is Passed");
	}
	...
	public void XP5S_TC_048_Sanity_TakeVideo_With_Back_Camera(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {
		...
		startLog("XP5S_Sanity_048");
		recordVideo("XP5S_Sanity_048");
		launch_an_app("gallery");
		takeCameraVideo(1);
		//press_Enter();
		validateCamera("Captured video");
		//validateBackCamera("MediaCodecSource: MediaCodecSource (video) started","MediaCodecSource: encoder (video) stopped","Camera","XP5S_Sanity_048");
		test.log(LogStatus.PASS, "Test case status is Passed");
	}
