...
public class XP5S_Call_Test extends XP5S_Data_Utils{
	...
	{
		extent = new ExtentReports("src/test/resources/extentreport/MO_MT_CallPerformanceReport.html", true);

		try {
			appiumService.TOTAL_NUM_OF_TESTCASES=GetMethods.TotalTestcase("Validate", this.getClass());
	...
	public void a_setupSys() throws MalformedURLException, InterruptedException, FileNotFoundException, AWTException{
		...
		properties=loadDriverAndProperties();
		XP5S_Data_Locator loc23=new XP5S_Data_Locator(aDriver);
		Locators_BaseUtil loc10 =new Locators_BaseUtil(aDriver);
		AOSP_Locators_SMS_MMS loc21=new AOSP_Locators_SMS_MMS(aDriver);

		PageFactory.initElements(new AppiumFieldDecorator(getDriver()),loc23);
		PageFactory.initElements(new AppiumFieldDecorator(getDriver()),loc10);
		PageFactory.initElements(new AppiumFieldDecorator(getDriver()),loc21);
...
/*
	...
	/*
	@Test(priority=1,dataProvider="XP5S_aosp_Data", dataProviderClass=com.aosp.Utils.DataProviders.class)
	...
	@Test(priority=2,dataProvider="XP5S_aosp_Data", dataProviderClass=com.aosp.Utils.DataProviders.class)
	...
	public void Validate_MO_MT_Call(Hashtable<String, String> data) throws InterruptedException, AWTException, IOException, ParseException {

		APP_LOGS.info("===========Aosp_XP5S_TestCases===========");

		if(JsonFileReaderAndWriter.primaryDevFirmwareReader().contains("8A")||JsonFileReaderAndWriter.primaryDevModelReader().contains("xp8800") || JsonFileReaderAndWriter.primaryDevModelReader().contains("80k")) {
			System.out.println("XP8 test cases");
			MO_MT_CALLS();
			test.log(LogStatus.PASS, "Test case executed");
		}
		else if (JsonFileReaderAndWriter.primaryDevModelReader().contains("xp5800") || JsonFileReaderAndWriter.primaryDevModelReader().contains("50k")) {
