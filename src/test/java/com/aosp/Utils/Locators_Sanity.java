...
//	@AndroidFindBy(xpath = "//android.widget.TextView[@text='Wi-Fi']")
	...
	public static AndroidElement android_folder;

	@AndroidFindBy(xpath="//*[contains(@content-desc,'Google apps')]")
	public static AndroidElement navigate_GoogleApps;
	@AndroidFindBy(xpath="//*[contains(@text,'Search')]")
	public static AndroidElement gmailSearch;

	@AndroidFindBy(xpath="//*[contains(@content-desc,'me Test_File')]")
	public static AndroidElement gmailselectFile;

	@AndroidFindBy(xpath="//*[contains(@content-desc,'Attachment')]")
	public static AndroidElement gmailAttchment;

	@AndroidFindBy(xpath="//*[contains(@content-desc,'Gmail')]")
	public static AndroidElement navigate_Gmail;

	@AndroidFindBy(xpath="//*[contains(@content-desc,'OPEN THE GMAIL APP')]")
	public static AndroidElement gmailOpen;

	@AndroidFindBy(xpath="//*[contains(@content-desc,'from:Sonim Smat - automationsmat@gmail.com ')]")
	public static AndroidElement gmailSelectMail;
	...
	@AndroidFindBy(xpath="//android.widget.TextView[@text='downloadfile.bin']")
	public static AndroidElement downloaded_file;
	
	@AndroidFindBy(xpath="//android.widget.TextView[@text='No Application']")
	public static AndroidElement noApplicationInPtt;
	...
	public static MobileElement PTTAppPageList;
	...
	@AndroidFindBy(uiAutomator = "new UiSelector().className(\"android.widget.RelativeLayout\").resourceId(\"com.sonim.borqs.launcher:id/main_layout\")")
	...
	@AndroidFindBy(uiAutomator = "new UiSelector().className(\"android.view.View\").resourceId(\"android:id/statusBarBackground\")")
	...
	@AndroidFindBy(xpath ="//android.widget.TextView[@text='Bluetooth']/../..//android.widget.Switch[@resource-id='android:id/switch_widget']")
	public static AndroidElement bluetooth_switch_QuickSet;
	...
	@AndroidFindBy(xpath ="//android.widget.TextView[@text='Airplane mode']/../..//android.widget.Switch[@resource-id='android:id/switch_widget']")
	public static AndroidElement airplane_switch_QuickSet;
	...
	@AndroidFindBy(xpath = "//android.widget.LinearLayout[@index='2']//android.widget.TextView[@index='1']")
	public static AndroidElement setTimeZoneSummary_oreo;
	
	@AndroidFindBy(xpath = "//android.widget.Switch[@text='OFF']")
	public static AndroidElement timeFormatDisabled_oreo;
	
	@AndroidFindBy(xpath="//android.widget.TextView[@text='Access Point Names']")
	public static AndroidElement access_Point_Names_oreo;
	
	@AndroidFindBy(xpath="//android.widget.TextView[@text='Storage']")
	public static AndroidElement internalStorageTxt_Oreo;
	...
	public static WebElement advanced_optn_oreo;
	...
	@AndroidFindBy(uiAutomator = "new UiSelector().className(\"android.widget.ImageButton\").resourceId(\"com.borqs.camera:id/video_switcher\")")
	public static AndroidElement swith_to_video;
	...
	@AndroidFindBy(uiAutomator="new UiSelector().className(\"android.widget.TextView\").resourceId(\"android:id/alertTitle\")")
	public static AndroidElement wifi_title_name;
