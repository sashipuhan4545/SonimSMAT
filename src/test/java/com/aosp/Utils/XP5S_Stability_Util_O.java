...
public class XP5S_Stability_Util_O extends BaseUtil{
...
//		Runtime.getRuntime().exec("adb -s "+p_Id+" shell input keyevent 5");		
	...
	public void validateCall(String str,String fileName,int n,String callType) throws IOException, InterruptedException {
		/*
		 * Validate via log String that MO-Voice  call initiated 
		 */
		SoftAssert s1 = new SoftAssert();
	...
	public void validateCall_Orio(String str,String fileName,int n,String callType,SoftAssert soft) throws IOException, InterruptedException {
		/*
		 * Validate via log String that MO-Voice  call initiated 
		 */
		SoftAssert s1 = new SoftAssert();
...
//			aDriver.pressKeyCode(AndroidKeyCode.KEYCODE_BACK);
	...
	public void validateUrlEntered(int n,SoftAssert soft)
	{
		...
		try { 
			...
			if(isElementExist(Locators_Stability.networkNotAvailable)){
				test.log(LogStatus.ERROR, "Entered Website page not Loaded successfully at iteration: "+n);
				soft.fail();
			} 
	...
	public void cameraPic() throws IOException, InterruptedException {
		...
		try {
			...
			customWait(2000);
			//				clickBtn(Locators_Stability.CamerIcon);
			customWait(1000);
